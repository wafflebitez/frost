...
class Channels(commands.Cog):
    ...
    async def counting(self, ctx, subcommand = None, arg = None):
            ...
            if subcommand == "enable":
                ...
                response = discord.Embed(title="Error", description="Invalid subcommand.", color=0xDC143C)
                response.add_field(name="Subcommands", value="`enable`, `disable`, `setchannel #channel`, `setnumber 123`, `setuser @user`, `blacklist`")
